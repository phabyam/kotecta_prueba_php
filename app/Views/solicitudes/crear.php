...
<form method="post" action="<?php echo site_url('/guardar_solicitud') ?>" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<select class="form-control" aria-label="Default select example" name='id_empleado'>
			<?php foreach ($empleados as $empleado) { ?>
				<option value="<?php echo $empleado['id'] ?>"><?php echo $empleado['nombre'] ?> (ID:<?php echo $empleado['id_empleado'] ?>)</option>
			<?php } ?>
		</select>
